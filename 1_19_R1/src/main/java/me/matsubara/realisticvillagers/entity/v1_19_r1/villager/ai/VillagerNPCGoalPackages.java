package me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai;
...
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.core.MoveToTargetSink;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.core.SetRaidStatus;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.core.VillagerPanicTrigger;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.core.YieldJobSite;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.core.*;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.fight.BackUpIfTooClose;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.fight.MeleeAttack;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.fight.SetWalkTargetFromAttackTargetIfTargetOutOfReach;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.fight.StopAttackingIfTargetInvalid;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.fight.*;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.hide.SetHiddenState;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.idle.InteractWithBreed;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.idle.VillagerMakeLove;
import me.matsubara.realisticvillagers.entity.v1_19_r1.villager.ai.behaviour.meet.SocializeAtBell;
...
public class VillagerNPCGoalPackages {
    ...
    private static InteractWith<LivingEntity, LivingEntity> createInteractWith(EntityType<? extends LivingEntity> type) {
    ...
    public static ImmutableList<Pair<Integer, ? extends Behavior<? super Villager>>> getRaidPackage() {
        return ImmutableList.of(
                Pair.of(0, new RunOne<>(ImmutableList.of(
                        ...
                        Pair.of(new VictoryStroll(VillagerNPC.SPRINT_SPEED_MODIFIER), 2)))),
                Pair.of(0, new CelebrateVillagersSurvivedRaid(600, 600)),
                Pair.of(0, runIfShouldNotHide(new VillageBoundRandomStroll(VillagerNPC.SPRINT_SPEED_MODIFIER))),
                Pair.of(1, runIfShouldHide(new LocateHidingPlaceDuringRaid(24, VillagerNPC.SPRINT_SPEED_MODIFIER))),
                getMinimalLookBehavior(),
    ...
    public static ImmutableList<Pair<Integer, ? extends Behavior<? super Villager>>> getHidePackage() {
        return ImmutableList.of(
                ...
                Pair.of(1, new LocateHidingPlace(32, VillagerNPC.SPRINT_SPEED_MODIFIER, 2)),
                getMinimalLookBehavior());
    }
    ...
    public static ImmutableList<Pair<Integer, ? extends Behavior<? super Villager>>> getFightPackage() {
        return ImmutableList.of(
                ...
                Pair.of(1, runIf(
                        ...
                        new SetWalkTargetFromAttackTargetIfTargetOutOfReach(living -> VillagerNPC.SPRINT_SPEED_MODIFIER))),
