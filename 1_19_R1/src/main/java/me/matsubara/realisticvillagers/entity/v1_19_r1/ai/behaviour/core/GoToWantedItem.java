package me.matsubara.realisticvillagers.entity.v1_19_r1.ai.behaviour.core;
...
public class GoToWantedItem extends Behavior<Villager> {
    ...
    public boolean checkExtraStartConditions(ServerLevel level, Villager villager) {
        ...
        return closest.closerThan(villager, maxDistToWalk)
                && (forcePickup || (!isOnPickupCooldown(villager) && !villager.getBrain().hasMemoryValue(MemoryModuleType.WALK_TARGET)));
    }
