package me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai;
...
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.*;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.GiveGiftToHero;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.SetEntityLookTarget;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.ShowTradesToPlayer;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.TradeWithVillager;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.*;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.GoToPotentialJobSite;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.GoToWantedItem;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.LookAtTargetSink;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.MoveToTargetSink;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.SetRaidStatus;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.VillagerPanicTrigger;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.core.YieldJobSite;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.fight.*;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.fight.BackUpIfTooClose;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.fight.MeleeAttack;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.fight.SetWalkTargetFromAttackTargetIfTargetOutOfReach;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.fight.StopAttackingIfTargetInvalid;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.hide.SetHiddenState;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.idle.InteractWithBreed;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.idle.VillagerMakeLove;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.meet.SocializeAtBell;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.rest.SleepInBed;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.stay.ResetStayStatus;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.work.HarvestFarmland;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.work.StartFishing;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.work.UseBonemeal;
import me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.work.WorkAtBarrel;
...
public class VillagerNPCGoalPackages {
    ...
    private static void updateActivityFromSchedule(Level level, LivingEntity living) {
        if (living instanceof VillagerNPC npc) {
            npc.updateActivityFromSchedule();
            return;
        }

        living.getBrain().updateActivityFromSchedule(
    ...
    @Contract(" -> new")
    public static @NotNull BehaviorControl<LivingEntity> resetRaidStatus() {
        return BehaviorBuilder.create((instance) -> instance.point((level, living, time) -> {
            if (level.random.nextInt(20) != 0) return false;

            Brain<?> brain = living.getBrain();

            Raid raid = level.getRaidAt(living.blockPosition());
            if (raid != null && !raid.isStopped() && !raid.isLoss()) return true;
    ...
    public static @NotNull OneShot<PathfinderMob> createStrollAroundStayPoint(MemoryModuleType<GlobalPos> memory, float speed, int distance) {
        ...
        return BehaviorBuilder.create((instance) -> instance
                ...
                .apply(instance, (target, pos) -> (level, mob, time) -> {
                    ...
                    if (time <= mutable.longValue()) return true;
