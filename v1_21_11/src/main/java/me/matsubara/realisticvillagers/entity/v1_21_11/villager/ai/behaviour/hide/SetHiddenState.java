package me.matsubara.realisticvillagers.entity.v1_21_11.villager.ai.behaviour.hide;
...
public class SetHiddenState extends Behavior<Villager> {
    ...
    public void start(ServerLevel level, @NotNull Villager villager, long game) {
        ...
        if (villager instanceof VillagerNPC npc) npc.updateActivityFromSchedule();
        ticksHidden = 0;
    }
}